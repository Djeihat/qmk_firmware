...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN] = LAYOUT_5x7(
        KC_ESC  , KC_1, KC_2   , KC_3   , KC_4  , KC_5  , KC_HOME,                       KC_END  , KC_6   , KC_7  , KC_8   , KC_9   , KC_0   , KC_EQL,
        KC_TAB  , KC_Q, KC_W   , KC_E   , KC_R  , KC_T  , KC_LBRC,                       KC_RBRC , KC_Y   , KC_U  , KC_I   , KC_O   , KC_P   , KC_SCLN,
        KC_LSPO , KC_A, KC_S   , KC_D   , KC_F  , KC_G  , KC_BSLS,                       KC_LWIN , KC_H   , KC_J  , KC_K   , KC_L   , KC_QUOT, KC_RSPC,
        KC_LCTL , KC_Z, KC_X   , KC_C   , KC_V  , KC_B  ,                                          KC_N   , KC_M  , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                        KC_LALT, KC_GRV,                                                                            KC_MINS, KC_RALT,
									      KC_BSPC, KC_DEL,                                         KC_ENT , KC_SPC,
                                                          XXXXXXX , LVL_MED,    XXXXXXX, KC_NLCK ,
    ...
    [_NUMPAD] = LAYOUT_5x7(
        XXXXXXX, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F12,                         KC_F11  , KC_F6  , KC_F7  , KC_F8, KC_F9  , KC_F10 , XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX ,                       XXXXXXX , XXXXXXX, KC_P7  , KC_P8, KC_P9  , KC_PSLS, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX ,                       XXXXXXX , XXXXXXX, KC_P4  , KC_P5, KC_P6  , KC_PPLS, KC_PMNS,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                           XXXXXXX, KC_P1  , KC_P2, KC_P3  , KC_PAST, KC_CIRC,
